 ...
 *
 * The babel plugins are resolved by name from the project,
 * by @nullvoxpopuli/ember-vite's no-config babel fallback.
 * (decorator-transforms is already a base dependency)
 */
const libraryDeps = {
